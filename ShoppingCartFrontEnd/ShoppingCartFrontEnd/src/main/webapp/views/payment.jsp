...
<script type="text/javascript" src="resources/scripts/ajaxjquery.js"></script>
<script
				...
				<form:form action="addpayment" commandName="payment">
					<table>
						...
						<td>Street Address :</td>
							...
							<td><form:input path="Streetaddrs" required="required" /></td>
						</tr>
						...
						<tr>
							...
							<td><form:input id="num" path="zip" required="required" /></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						...
						<tr>
							...
							<td><form:input id="num" path="mob" required="required"/></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						...
						<tr>
							...
							<td><form:input path="payemail" required="required"/></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						...
						<tr>
							...
							<td><form:input path="payfnam" required="required"/></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						...
						<tr>
							...
							<td><form:input path="paylname" required="required"/></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						...
						<tr>
							...
							<td><form:input id="num" path="paycardno" required="required" maxlength="16"/></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						...
						<tr>
							...
							<td><form:input path="cardexpirydate" required="required"/></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						...
						<tr>
							...
							<td><form:input id="num" path="ccv" required="required" maxlength="3"/></td>
						</tr>
